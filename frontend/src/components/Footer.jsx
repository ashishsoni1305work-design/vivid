...
const Footer = () => {
  ...
  const products = [
    { name: "Industrial RO Plants", path: "/products?category=RO Plants" },
    { name: "Effluent Treatment Plants", path: "/products?category=Treatment Plants" },
    { name: "Water Softeners", path: "/products?category=Water Softeners" },
    { name: "Water Chillers", path: "/products?category=Coolers & Chillers" },
    { name: "DM Plants", path: "/products" },
  ];
            ...
            <ul className="space-y-3">
              {products.map((item) => (
                <li key={item.name}>
                  <Link 
                    to={item.path} 
                    className="text-blue-100 text-sm hover:text-white flex items-center gap-2 transition-colors"
                  >
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:vividh2osolutions@gmail.com" className="text-blue-100 text-sm hover:text-white transition-colors">
